...
public class LOTMPurpleStainedGlassPane extends IronBarsBlock implements BeaconBeamBlock {
    private final DyeColor color;

    public LOTMPurpleStainedGlassPane(DyeColor pColor, Properties pProperties) {
