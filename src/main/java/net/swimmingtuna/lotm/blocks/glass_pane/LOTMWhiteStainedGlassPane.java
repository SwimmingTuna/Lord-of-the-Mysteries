...
public class LOTMWhiteStainedGlassPane extends IronBarsBlock implements BeaconBeamBlock {
    private final DyeColor color;

    public LOTMWhiteStainedGlassPane(DyeColor pColor, Properties pProperties) {
