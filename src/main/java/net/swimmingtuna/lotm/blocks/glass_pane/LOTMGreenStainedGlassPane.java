...
public class LOTMGreenStainedGlassPane extends IronBarsBlock implements BeaconBeamBlock {
    private final DyeColor color;

    public LOTMGreenStainedGlassPane(DyeColor pColor, Properties pProperties) {
