...
public class LOTMPinkStainedGlassPane extends IronBarsBlock implements BeaconBeamBlock {
    private final DyeColor color;

    public LOTMPinkStainedGlassPane(DyeColor pColor, Properties pProperties) {
