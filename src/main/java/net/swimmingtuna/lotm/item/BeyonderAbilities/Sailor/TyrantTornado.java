...
public class TyrantTornado extends Item implements ReachChangeUUIDs {

    public TyrantTornado(Properties pProperties) { //IMPORTANT!!!! FIGURE OUT HOW TO MAKE THIS WORK BY CLICKING ON A
        super(pProperties);
    }
