...
public class LOTMOrangeStainedGlassPane extends IronBarsBlock implements BeaconBeamBlock {
    private final DyeColor color;

    public LOTMOrangeStainedGlassPane(DyeColor pColor, Properties pProperties) {
