...
public class LOTMMagentaStainedGlassPane extends IronBarsBlock implements BeaconBeamBlock {
    private final DyeColor color;

    public LOTMMagentaStainedGlassPane(DyeColor pColor, Properties pProperties) {
