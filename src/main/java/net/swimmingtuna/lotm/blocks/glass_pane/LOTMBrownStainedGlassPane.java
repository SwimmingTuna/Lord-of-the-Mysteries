...
public class LOTMBrownStainedGlassPane extends IronBarsBlock implements BeaconBeamBlock {
    private final DyeColor color;

    public LOTMBrownStainedGlassPane(DyeColor pColor, Properties pProperties) {
