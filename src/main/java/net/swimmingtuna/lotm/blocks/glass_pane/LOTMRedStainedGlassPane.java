...
public class LOTMRedStainedGlassPane extends IronBarsBlock implements BeaconBeamBlock {
    private final DyeColor color;

    public LOTMRedStainedGlassPane(DyeColor pColor, Properties pProperties) {
