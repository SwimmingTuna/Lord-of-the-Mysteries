...
public class LOTMGrayStainedGlassPane extends IronBarsBlock implements BeaconBeamBlock {
    private final DyeColor color;

    public LOTMGrayStainedGlassPane(DyeColor pColor, Properties pProperties) {
