...
public class MCLightningBoltEntityRenderer extends EntityRenderer<MCLightningBoltEntity> {
    public MCLightningBoltEntityRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }

    public void render(MCLightningBoltEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
