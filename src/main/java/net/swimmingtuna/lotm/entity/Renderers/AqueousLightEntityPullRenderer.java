...
public class AqueousLightEntityPullRenderer extends EntityRenderer<AqueousLightEntityPull> {
    ...
    @Override
    public void render(AqueousLightEntityPull entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffers, int packedLight) {
        poseStack.pushPose();
        ...
        vertex(builder, pose, normal, packedLight, 0, 0, 0, 1);
        vertex(builder, pose, normal, packedLight, 1, 0, 1, 1);
        vertex(builder, pose, normal, packedLight, 1, 1, 1, 0);
        vertex(builder, pose, normal, packedLight, 0, 1, 0, 0);
    ...
    @Override
    public ResourceLocation getTextureLocation(AqueousLightEntityPull entity) {
