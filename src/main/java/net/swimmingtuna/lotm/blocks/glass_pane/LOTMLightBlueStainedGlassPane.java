...
public class LOTMLightBlueStainedGlassPane extends IronBarsBlock implements BeaconBeamBlock {
    private final DyeColor color;

    public LOTMLightBlueStainedGlassPane(DyeColor pColor, Properties pProperties) {
