...
public class LOTMCyanStainedGlassPane extends IronBarsBlock implements BeaconBeamBlock {
    private final DyeColor color;

    public LOTMCyanStainedGlassPane(DyeColor pColor, Properties pProperties) {
