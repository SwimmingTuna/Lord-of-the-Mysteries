...
public class LOTMLightGrayStainedGlassPane extends IronBarsBlock implements BeaconBeamBlock {
    private final DyeColor color;

    public LOTMLightGrayStainedGlassPane(DyeColor pColor, Properties pProperties) {
